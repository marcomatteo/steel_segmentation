    ...
    tfm_list = [
        ...
        alb.OneOf(
            [
                ...
                alb.RandomGridShuffle(always_apply=False, p=0.2, grid=(1, 2)) # added
            ], p=0.6),
    ]
...
bs = 12
# size = (224,512)
size = (224,1568) # try at full size training
kfolds = 1
...
epochs = 30
lr = 3e-4
only_faulty = False # only defected images or all the train_images
one_cycle = True # fit_one_cycle if True, fit otherwise
mixed_prec = True # fp16() learner
