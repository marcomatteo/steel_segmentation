...
__all__ = ['get_classification_dls', 'AlbumentationsTransform', 'image2tensor', 'ToTensor', 'get_segmentation_dls',
           'get_segmentation_dls_from_df', 'get_train_dls']
...
class ToTensor(Transform):
    ...
    def encodes(self, o:PILImage): return o._tensor_cls(image2tensor(o))
