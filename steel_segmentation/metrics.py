...
__all__ = ['ModDiceMulti', 'single_dice_coef', 'single_dice_coef_channel', 'KaggleDiceMulti', 'FastKaggleDiceMulti',
           'KaggleDice', 'FastKaggleDice']
...
# Cell
KaggleDiceMulti = AccumMetric(single_dice_coef_channel, to_np=True, flatten=False, thresh=0.5)

# Cell
FastKaggleDiceMulti = AccumMetric(single_dice_coef_channel, to_np=True, flatten=False)

# Cell
KaggleDice = AccumMetric(single_dice_coef, to_np=True, flatten=False, thresh=0.5)

# Cell
FastKaggleDice = AccumMetric(single_dice_coef, to_np=True, flatten=False)