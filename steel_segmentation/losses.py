# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/14_loss.ipynb (unless otherwise specified).

__all__ = ['SoftDiceLoss', 'WeightedSoftDiceLoss', 'SoftBCEDiceLoss', 'MultiClassesSoftBCEDiceLoss', 'SoftDiceLoss',
           'WeightedSoftDiceLoss', 'SoftBCEDiceLoss', 'MultiClassesSoftBCEDiceLoss', 'IoULoss']
